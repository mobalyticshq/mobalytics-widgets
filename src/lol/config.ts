export const CDN_LOL_IMG_PATH = 'https://cdn.mobalytics.gg/assets/lol/images';
export const CDN_CGI_LOL_IMG_PATH = 'https://cdn.mobalytics.gg/cdn-cgi/image';
export const CDN_COMMON_IMG_PATH = 'https://cdn.mobalytics.gg/assets/common/images';
export const CDN_COMMON_ICON_PATH = 'https://cdn.mobalytics.gg/assets/common/icons';
